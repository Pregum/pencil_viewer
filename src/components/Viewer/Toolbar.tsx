...
const NOTE_ICON = (
  <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
    <path d="M3 2H13V11L9 15H3V2Z" stroke="currentColor" strokeWidth="1.2" fill="#FEF3C7" />
    <path d="M13 11H9V15" stroke="currentColor" strokeWidth="1.2" fill="none" />
  </svg>
);

const PEN_ICON = (
  <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
    <path d="M10.5 1.5L14.5 5.5L5 15H1V11L10.5 1.5Z" stroke="currentColor" strokeWidth="1.2" fill="none" />
    <path d="M9 3L13 7" stroke="currentColor" strokeWidth="1.2" />
  </svg>
);
