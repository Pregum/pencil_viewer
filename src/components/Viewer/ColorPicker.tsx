...
export function ColorPicker({ color, onChange, onClose, anchorRect }: Props) {
  ...
  // prop の color が外から変わった場合に同期。effect ではなくレンダー中に
  // 調整する（React 公式の "Adjusting state when a prop changes"）。
  // effect でやると古い色が 1 フレーム出る (#78)。
