...
- **Figma ライクなキャンバス操作** — ズーム・パン・フレームナビゲーション(詳細は下記)

## 操作方法(キーボード & マウス)

Figma に近い操作体系を採用しています。

### ズーム

| 操作 | 機能 |
|---|---|
| `Cmd/Ctrl` + スクロール | カーソル位置を中心にズーム |
| `Cmd/Ctrl` + `+` | ズームイン |
| `Cmd/Ctrl` + `-` | ズームアウト |
| `Cmd/Ctrl` + `0` | 全体をフィット(リセット) |
| `Cmd/Ctrl` + `1` | 100% 表示 |
...
| 操作 | 機能 |
|---|---|
| `Cmd/Ctrl` + `P` | フレーム検索(コマンドパレット) |
| `Cmd/Ctrl` + `[` | 前のビューに戻る |
| `Cmd/Ctrl` + `]` | 次のビューに進む |
| ツールバーのドロップダウン | フレームを選択してズーム |

### その他

| 操作 | 機能 |
|---|---|
| `Cmd/Ctrl` + `/` | ショートカットキー一覧を表示 |
| `Esc` | ダイアログを閉じる |
